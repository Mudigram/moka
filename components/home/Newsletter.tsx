    ...
    return (
        <section className="py-24 px-6 bg-[#f5f0ff] relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-[2.5rem] p-12 md:p-20 shadow-soft relative z-10 text-center space-y-8 animate-in fade-in zoom-in-95 duration-1000">
                <div className="w-20 h-20 bg-electric-purple rounded-full flex items-center justify-center text-white mx-auto shadow-lg shadow-electric-purple/20">
                ...
                <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-3 pt-4">
                    ...
                    <Button
                        type="submit"
                        className="h-14 px-8 rounded-xl bg-electric-purple hover:bg-electric-purple/90 text-white font-bold transition-all active:scale-95 glow-purple shadow-lg shadow-electric-purple/20"
                    >
                        Subscribe
                    </Button>
                </form>
