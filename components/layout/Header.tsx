            ...
            <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
                ...
                <nav className="hidden md:flex items-center gap-10">
                    <ul className="flex gap-10 text-base font-semibold text-foreground/80">
                        <li><Link href="/stories" className="hover:text-electric-purple transition-colors">Stories</Link></li>
                    ...
                    <Link href="/contact" className="bg-electric-purple text-white px-8 py-3 rounded-xl text-base font-bold hover:bg-electric-purple/90 transition-all active:scale-95 glow-purple hover:glow-purple">
                        Join Now
                    </Link>
                </nav>
