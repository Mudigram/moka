            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                ...
                <div className="space-y-6">
                    <Link href="/" className="inline-block">
                        <Image src={logo} alt="Moka Logo" width={100} height={36} className="h-auto w-auto opacity-90" />
                    </Link>
                    <p className="text-sm text-foreground/60 leading-relaxed max-w-xs">
                        Connecting young African professionals with the stories and tools they need to thrive.
                    </p>
                    <div className="flex gap-4 text-electric-purple">
                        {/* Social Icons Placeholders */}
                        <div className="w-5 h-5 bg-electric-purple/10 rounded-full flex items-center justify-center cursor-pointer hover:bg-electric-purple/20 transition-colors">
                ...
                {/* Links Sections */}
                <div>
                    <h3 className="text-sm font-bold uppercase tracking-wider mb-6 text-foreground/80">Explore</h3>
                    <ul className="space-y-4 text-sm text-foreground/60">
                        ...
                        <li><Link href="/contributors" className="hover:text-electric-purple transition-colors">Contributors</Link></li>
                    </ul>
                </div>

                <div>
                    <h3 className="text-sm font-bold uppercase tracking-wider mb-6 text-foreground/80">Company</h3>
                    <ul className="space-y-4 text-sm text-foreground/60">
                ...
                <div>
                    <h3 className="text-sm font-bold uppercase tracking-wider mb-6 text-foreground/80">Legal</h3>
                    <ul className="space-y-4 text-sm text-foreground/60">
